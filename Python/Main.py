...
def main():
    ...
    if args.Report_Type == 'FULL':
        CopyFiles.copyanything('c:\Users\Scott\Dropbox\Scripts\Python\AF-Report-full\Latex\ArcFlash', AFReport_Path)
        ...
        CopyFiles.copyanything('c:\Users\Scott\Dropbox\Scripts\Python\AF-Report-full\Latex\PDC', PDCReport_Path)
	print '\n', PDCReportFolderName, ' Generated', '\n'
        #Generate PDC Latex Report
        PDC_Path = '{!s}/{!s}'.format(PDCReport_Path, "PDC")
        os.chdir(PDC_Path)
        subprocess.call(["perl", "/c/Users/Scott/Dropbox/Scripts/Python/AF-Report-full/Perl/CreatePDC.pl", args.PCE_Rep, args.Job_Num, args.Customer_Comp, args.Customer_Build, args.Customer_Add, args.Working_Dir, args.Report_Type])
	...
	print '\n', PDCReportFolderName, ' Generated', '\n'
        ...
        CopyFiles.copyanything('c:\Users\Scott\Dropbox\Scripts\Python\AF-Report-full\Latex\SCC', SCCReport_Path)
	print '\n', SCCReportFolderName, ' Generated', '\n'
        #Generate SCC Latex Report
        SCC_Path = '{!s}/{!s}'.format(SCCReport_Path, "SCC")
        os.chdir(SCC_Path)
        subprocess.call(["perl", "/c/Users/Scott/Dropbox/Scripts/Python/AF-Report-full/Perl/CreateSCC.pl", args.PCE_Rep, args.Job_Num, args.Customer_Comp, args.Customer_Build, args.Customer_Add, args.Working_Dir, args.Report_Type])
